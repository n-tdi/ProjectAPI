...
public class DaemonScripts extends Project {
    public DaemonScripts() {
        super(2, "Daemon Scripts",
                ...
                new Preview("Daemon Scripts",
                        "A super powerful collection of SystemD and Shell scripts",
